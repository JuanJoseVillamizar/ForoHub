        ...
        return args -> {
            ...
            if (!userRepository.existsByEmail("superAdmin@gmail.com")) {
                ForumUser createDevelop = ForumUser.builder()
                        ...
                        .password("$2y$10$jFVohBvzngR7ukWXWnDf4OFiJHZHNjxldIBKLh1O3F2QgN8gB4UJ2")//superAdmin1234
                        .profile(developerProfile)
                        .build();
                userRepository.save(createDevelop);
            }

            if (!userRepository.existsByEmail("adminForum@gmail.com")) {
                ForumUser createAdmin = ForumUser.builder()
                        .name("ADMIN")
                        .email("adminForum@gmail.com")
